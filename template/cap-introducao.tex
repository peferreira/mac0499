...
. O Algoritmo da IFT será usado para separar objetos do fundo em uma imagem. Para aplicar a IFT sobre os superpixels é preciso realizar um pré-processamento da imagem para a criação dessa estrutura. 
\paragraph*{}
...
\paragraph*{}
Neste trabalho será verificado o comportamento do algoritmo da IFT ao utilizar o SLIC \citet{slic:sp_slic}
