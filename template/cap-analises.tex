...
Representado na imagem dos resultados pela curva roxa traçejada, a IFT a nível de pixels obteve bons resultados quando as sementes eram mais significativas, raios de erosão menores do que 10 pixels, sendo a primeira colocada entre as curvas geradas no intervalo de raio 0 a 5. No entanto, ela piora sua acurácia ao longo da diminuição do raio da erosão.

\subsection{IFT sobre superpixels }

E em seguida foi executada a mesma rotina, mas passando a opção da IFT sobre superpixels e o número de superpixels a serem gerados pelo SLIC como parâmetros.
...
\subsubsection{400 superpixels} Um pouco pior no início, quando comparado a IFT sobre a imagem com 100 superpixels, no entanto, logo o comportamento da curva se mantém bem parecido com a curva gerada pela IFT sobre 100 superpixels.
\subsubsection{900 e 1600 superpixels} Ambas obtiveram desempenho similar, e mostram que quanto maior o número de superpixels, de acordo com esse experimento, pior foi a acurácia para raios pequenos de erosão ( caso onde as sementes fornecem muita informação do objeto e do fundo).
