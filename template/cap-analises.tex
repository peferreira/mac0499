...
\begin{itemize}
\item Variação do raio de erosão sobre as imagens do gabarito.
\item Iterações de um suário robô.
\end{itemize}
...
\caption{\label{fig:resultados} Acurácia é o valor do Coeficiente de Dice, e as curvas apresentadas são as curvas médias de todas as imagens do grabcut, a partir de sementes geradas por erosão.}
\end{center}
\end{figure}
